...
OLMO_2_1124_7B_INSTRUCT_WEIGHTS_PATH = os.path.join(MODEL_WEIGHTS_DIR, "allenai/OLMo-2-1124-7B-Instruct")
...
SOLAR_10_7B_INSTRUCT_V1_0_WEIGHTS_PATH = os.path.join(MODEL_WEIGHTS_DIR, "upstage/SOLAR-10.7B-Instruct-v1.0")

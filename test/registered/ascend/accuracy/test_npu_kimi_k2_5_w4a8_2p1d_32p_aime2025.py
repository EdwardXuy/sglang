...
class TestNPUKimiK2_5_W4A8_2P1D_32P_AIME2025(TestAscendAccuracyMultiNodePdSepTestCaseBase):
    """Test NPU accuracy for Kimi-K2.5-w4a8 2p1d_32p on AIME 2025"""
    ...
    def test_npu_kimi_k2_5_w4a8_2p1d_32p_aime2025(self):
        """Run NPU accuracy test for Kimi-K2.5-w4a8 2p1d_32p on AIME 2025"""
        self.run_accuracy()

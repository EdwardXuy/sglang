...
class TestNPUMiniMaxM2_5_W8A8_1P1D_48P_In64k_Out1k_50ms(TestAscendPerfMultiNodePdSepTestCaseBase):
    """Test NPU performance for MiniMax-M2.5-w8a8 1p1d_48p PD separation in64k out1k"""
    ...
    def test_npu_minimax_m2_5_w8a8_1p1d_48p_in64k_out1k_50ms(self):
        """Run NPU performance test for MiniMax-M2.5-w8a8 1p1d_48p"""
        self.run_throughput()
